...
public class TaskController {
    ...
    public ResponseEntity<Object> createTask(
        ...
        try {
            ...
            return ResponseEntity.badRequest()
                    .body(new com.todoapp.resource.dto.ErrorResponseDto("Invalid request", e.getMessage()));
        } catch (Exception e) {
            log.error("Error creating task for user {}: {}", userId, e.getMessage(), e);
            return ResponseEntity.internalServerError()
                    .body(new com.todoapp.resource.dto.ErrorResponseDto("Internal server error", e.getMessage()));
        }
    }
    ...
    public ResponseEntity<com.todoapp.resource.dto.TaskDto.Stats> getTaskStats(
        ...
        com.todoapp.resource.dto.TaskDto.Stats stats = taskService.getTaskStatsInRange(userId, startDate, endDate);
